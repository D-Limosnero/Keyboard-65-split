...
keyboardHID keyboardhid = {0,0,0,0,0,0};
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : Col0_Pin Row0_Pin Col1_Pin Row1_Pin */
  GPIO_InitStruct.Pin = Col0_Pin|Row0_Pin|Col1_Pin|Row1_Pin;
